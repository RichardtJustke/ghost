...
Item {
    ...
    property real timerAlarmVolume: notifSettings && notifSettings.timerAlarmVolume !== undefined ? notifSettings.timerAlarmVolume : 100

    Timer {
        id: timerAlarmVolumeDebounce
        interval: 120
        repeat: false
        onTriggered: notificationsTabRoot.updateNotifSetting("timerAlarmVolume", notificationsTabRoot.timerAlarmVolume)
    }
    ...
    function syncSettings() {
        ...
        notificationsTabRoot.timerAlarmVolume = s.timerAlarmVolume !== undefined ? s.timerAlarmVolume : 100;
    ...
    Flickable {
        ...
        ColumnLayout {
            ...
            Rectangle {
                Layout.fillWidth: true
                implicitHeight: rowTimerAlarmLayout.implicitHeight + rootObj.s(24)
                radius: ThemeBackend.borderRadius
                color: Qt.alpha(ThemeBackend.surface0, 0.4)
                border.width: 0

                RowLayout {
                    id: rowTimerAlarmLayout
                    anchors.left: parent.left
                    anchors.right: parent.right
                    anchors.leftMargin: rootObj.s(14)
                    anchors.rightMargin: rootObj.s(14)
                    ...
                    ColumnLayout {
                        ...
                        Text {
                            Layout.fillWidth: true
                            text: I18n.t("guide.notifications.timer_alarm.title")
                            font.family: ThemeBackend.fontFamily
                            font.pixelSize: rootObj.s(13)
                            color: ThemeBackend.text
                        }
                        ...
                        Text {
                            Layout.fillWidth: true
                            text: I18n.t("guide.notifications.timer_alarm.desc")
                            font.family: ThemeBackend.fontFamily
                            font.pixelSize: rootObj.s(11)
                            color: ThemeBackend.subtext0
                        }
                    ...
                    Draggable {
                        ...
                        value: notificationsTabRoot.timerAlarmVolume
                        ...
                        onMoved: function(val) {
                            ...
                            if (notificationsTabRoot.timerAlarmVolume !== rounded) {
                                notificationsTabRoot.timerAlarmVolume = rounded;
                                timerAlarmVolumeDebounce.restart();
                            }
                        }
                        onDragFinished: {
                            timerAlarmVolumeDebounce.stop();
                            notificationsTabRoot.updateNotifSetting("timerAlarmVolume", notificationsTabRoot.timerAlarmVolume);
                            if (notificationsTabRoot.timerAlarmVolume > 0 && typeof Sounds !== "undefined" && typeof Sounds.playSfx === "function") {
                                Sounds.playSfx("quickactions/timer_complete.wav", notificationsTabRoot.timerAlarmVolume / 100, 0, true);
                            }
                        }
                    }
                }
