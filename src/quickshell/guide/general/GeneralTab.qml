            ...
            Rectangle {
                ...
                RowLayout {
                    ...
                    ColumnLayout {
                        ...
                        Text {
                            Layout.fillWidth: true
                            text: I18n.t("guide.general.shellscale.title") || "Shell UI scale"
                            font.family: ThemeBackend.fontFamily
                            font.pixelSize: rootObj.s(13)
                            color: ThemeBackend.text
                        }
                        ...
                        Text {
                            Layout.fillWidth: true
                            text: I18n.t("guide.general.shellscale.desc") || "Resize the shell interface independently from the monitor's compositor scale"
                            font.family: ThemeBackend.fontFamily
                            font.pixelSize: rootObj.s(11)
                            color: ThemeBackend.subtext0
                        }
                    ...
                    Draggable {
                        ...
                        showValueBubble: true
                        valueFormatter: function(v) { return Math.round(v) + "%" }
                        value: Math.round(generalTabRoot.shellScale * 100)
                        backgroundColor: ThemeBackend.surface0
                        accentColor: ThemeBackend.mauve
                        handleColor: ThemeBackend.text
                        handleBorderColor: ThemeBackend.mantle
                        onMoved: function(val) {
                            ...
                            if (generalTabRoot.shellScale !== rounded) {
                                generalTabRoot.shellScale = rounded;
                                sfxVolumeDebounceTimer.restart();
                            }
                        }
                        onDragFinished: {
