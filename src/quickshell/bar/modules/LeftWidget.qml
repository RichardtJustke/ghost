...
Rectangle {
    ...
    Row {
        ...
        IconButton {
            id: launcherButton
            visible: leftLayout.showLauncherBtn
            height: leftLayout.pillHeight
            width: leftLayout.showLauncherBtn ? (barWindow ? barWindow.s(leftWidgetRoot.isCompact ? 30 : 32) : (leftWidgetRoot.isCompact ? 30 : 32)) : 0
            iconOffsetX: -2
            ...
            Timer { running: leftWidgetRoot.moduleActive && leftWidgetRoot.showLayout && !launcherButton.initAnimTrigger; interval: 40; onTriggered: launcherButton.initAnimTrigger = true }
            opacity: initAnimTrigger ? 1.0 : 0.0
            transform: Translate { y: launcherButton.initAnimTrigger ? 0 : (barWindow ? barWindow.s(15) : 15); Behavior on y { NumberAnimation { duration: 620; easing.type: Easing.OutQuint } } }
